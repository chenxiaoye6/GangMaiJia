...
import com.example.administrator.gangmaijia.Activity.Purchase.Logistic_detail;
...
public class GrabLogisticAdapter extends BaseAdapter {
                    ...
                    try {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    //上传抢单请求
                                    new OkHttpUtils().postKeyValue(mHandler, Internet.INSERTRELATIONLOGISTIC, builder);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            }
    ...
    public GrabLogisticAdapter(Context context, List<Logistic> dataList, int type, int n) {
...
//        try {
        ...
        holder.tv_list_alldingdan_guige.setText("发\t货\t地：");
        holder.tv_list_alldingdan_caizhi.setText("收\t货\t地：");
        holder.et_list_alldingdan_name.setText(lists.get(position).getProduct_name());
        holder.et_list_alldingdan_guige.setText(lists.get(position).getDelivery_place());
        holder.et_list_alldingdan_caizhi.setText(lists.get(position).getDestination());
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        //
...
//            holder.tv_list_alldingdan_detail.setEnabled(false);
        ...
        holder.tv_list_alldingdan_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mainContext, Logistic_detail.class);
